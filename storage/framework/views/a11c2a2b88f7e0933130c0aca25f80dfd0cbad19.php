    ...
    <div class="container">
        ...
        <div class="notification-list-wrapper">
          ...
          <?php if(Session::get('uname')!=""){?>
            ...
            <?php $__currentLoopData = $notification_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

            <div class="notification-list">
                <div class="user-image"><img src="images/user.png"></div>
                <div class="user-notification">
                    <span class="user-name"><?php echo e($notification->seeker_name); ?></span> wants some help from you !
        ...
        <div class="menu notification-wrapper">
            ...
            <?php if(Session::get('uname')!=""){?>
            <div class="notification-count-wrapper"><?php echo e(count($notification_data)+1); ?></div>
            <?php } ?>
        </div>


        <div class="menu">
            <a href="/<?php echo e(Session::get('uname')); ?>">
