    ...
    <div class="nav-wrapper">
        ...
        <div id="notification-btn" style="display:block;float:right;margin:0 18px; ">
            ...
            @if(count($request_data)>0)
                <div id="notification-active" class="notification-active"><div>{{count($request_data)}}</div></div>
            @endif
        </div>
        ...
        <div id="-btn" style="display:block;float:right;margin:0 18px; ">
            <a href="/{{$user_data[0]->username}}"><i class="material-icons">perm_identity</i></a>
        </div>
        <div id="-btn" style="display:block;float:right;margin:0 18px; ">
...
<div id="notifications-wrapper" class="notifications-wrapper z-depth-2" >
    ...
    @foreach($request_data as $help)

        <div id="{{$help->help_id}}" class="row col l12 notifications-wrapper-list">
            <div class="col l3 s2 user-img">
                <img src="uploads/default.png">
            </div>
            <div class="col l9 s10">
                <span style="color:#00b0ff;font-weight:400">{{$help->first_name}}</span> wants some help from you !
                <div  class="col l6 s6" style="padding-left:0"><button id="accept_{{$help->help_id}}" class="help-now-btn">Help !</button></div>
                <div  class="col l6 s6" style="padding-right:0"><button id="reject_{{$help->help_id}}" class="help-reject-btn">Delete</button></div>
            </div>
            <div class="col l12">
