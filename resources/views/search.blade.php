        ...
        <div class="col-lg-12 ">
            <div class="block" style="">
                ...
                <div class="search-page-results-wrapper">
                  ...
                  @foreach($helpers_data as $helper)
                    ...
                    <div class="search-page-results-profile-wrapper">
                      ...
                      <div class="search-page-results-profile-wrapper-inner">
                          ...
                          <div class="search-page-results-info-wrapper">
                              <div class="search-page-results-info"><a href="{{$helper->username}}">{{$helper->first_name.' '.$helper->last_name}}</a></div>
                              <div class="search-page-results-info-sub"><i class="material-icons">work</i>{{$helper->job}}</div>
                              <div class="search-page-results-info-sub"><i class="material-icons">location_on</i>{{$helper->city}}, {{$helper->district}}</div>
                          </div>
